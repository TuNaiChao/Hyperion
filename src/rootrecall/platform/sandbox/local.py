...
from rootrecall.platform.sandbox.base import Sandbox
from rootrecall.platform.sandbox.env_policy import build_sandbox_env
...
class LocalSandbox(Sandbox):
    ...
    def read_file(
        ...
        from rootrecall.platform.sandbox._search import is_probably_binary
    ...
    def grep(self, path: str, pattern: str, *, max_results: int = 100) -> list[str]:
        ...
        from rootrecall.platform.sandbox._search import find_grep_matches
