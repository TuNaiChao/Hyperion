...
用法:
  uv run python eval/run_eval.py eval/sets/hyperion.jsonl hyperion [--base-dir data/code_index] [--top-k 5]
...
from hyperion.services.code_index.eval.runner import format_report, load_eval_set, run_eval
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Hyperion 代码检索评测")
